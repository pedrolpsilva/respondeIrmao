...
import { COMPARTILHAR_QUESTIONS, QUIZ_QUESTIONS, TEOLOGICO_QUESTIONS, TORRE_QUESTIONS } from '@/constants/questions';
...
describe('questionsService', () => {
  ...
  describe('loadLocalQuestions', () => {
    ...
    it('should load successfully from cache if data exists', async () => {
      ...
      const mockTeologico = [
        { id: 'teo1', text: 'TEO1', correctAnswer: 'TEOA', level: 'teologico' }
      ];
